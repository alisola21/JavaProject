...
public class UtenteNonAbbonato implements Serializable {
    ...
    //variabile statica necessaria al Serializable
    ...
    public UtenteNonAbbonato(int eta) {
        this.eta = eta;
        //lo inizializzo a 0, poi aggiornerò con prezzo giusto
    ...
    public boolean isRidottoBambiniEAnziani() {
        if ((eta <= 12) || (eta >= 65))
    ...
    private boolean isStudente() {
        System.out.println("L'utente è uno studente?");
